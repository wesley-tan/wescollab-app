      ...
      <div className="max-w-md w-full space-y-8 p-8">
        ...
        <div className="mt-8 space-y-4">
          ...
          {urlError && (
            <div className="bg-red-50 border border-red-200 rounded-md p-4">
              <div className="text-sm text-red-800">
                ...
                {urlError === 'domain_restricted' && 'Email authentication failed.'}
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed"
          >
